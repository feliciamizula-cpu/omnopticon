    ...
    public static IReadOnlyList<ProviderAccountRecord> CreateAccounts(DateTimeOffset now)
    {
        ...
        [
            new ProviderAccountRecord
            {
                ...
                RelatedToolsJson = Tools("openai", "codex"),
                RelatedModelsJson = Models("chatgpt-mini", "chatgpt-nano", "chatgpt-5.5", "codex-5.3", "gpt-5-codex"),
            ...
            new ProviderAccountRecord
            {
                ...
                RelatedToolsJson = Tools("gemini", "opencode"),
